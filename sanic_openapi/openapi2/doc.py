...
class Object(Field):
    ...
    def definition(self):
        ...
        for prop_id, property_data in definition.get("properties").items():
            if "required" in property_data:
                ...
                prop_data_items = property_data["items"]
                if property_data["type"] == "array" and "required" in prop_data_items:
